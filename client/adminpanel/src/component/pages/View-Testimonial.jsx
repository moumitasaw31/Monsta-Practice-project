            ...
            <table className='w-[100%] '>
              <thead className=''>
                <tr className='text-[#374151] bg-[#F9FAFB]  text-[12px] uppercase '>
                  ...
                  <th className='p-3 text-left w-[900px] '>Name</th >
                  <th className='p-3 text-left w-[150px]'>Image</th >
                  <th className='p-3 text-left w-[250px]'>Designation</th >
                  <th className='p-3 text-left w-[150px]'>Rating</th >
              ...
              <tr className=' text-[gray]  border-[#e4e0e0]'>
                ...
                <td className='p-3 text-left text-[black] font-[500]'>Neil Sims</td>
