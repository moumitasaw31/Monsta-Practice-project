          ...
          <div className='rounded-[8px] m-5 border '>
            ...
            <div className='  '>
              <div className='flex justify-between items-center rounded-[8px_8px_0px_0px] bg-[#F1F5F9]' >
                <h1 className='text-[25px] font-[500] p-4'>View Testimonial
            ...
            <table className='w-[100%] '>
              <thead className=''>
                <tr className='text-[#374151] bg-[#F9FAFB]  text-[12px] uppercase '>
                  ...
                  <th className='p-3 text-left w-[1000px] '>Title</th >
                  <th className='p-3 text-left w-[150px]'>Image</th >
                  <th className='p-3 text-left  w-[400px]'>	Description</th >
              ...
              <tr className=' text-[gray] font-[500] border-[#e4e0e0] hover:bg-[#F9FAFB] rounded-[0px_0px_8px_8px] text-[14px]'>
                <td className='p-3 text-left '><input type="checkbox" /></td>
                <td className='p-3 text-left text-[#374151]'>Neil Sims</td>
                <td className='p-3 text-left'> <img src="https://packshifts.in/images/iso.png" className='w-12' alt="" /></td>
                <td className='p-3 text-left'>CEO Of SunPark	</td>
              ...
              <tr className=' text-[gray] font-[500]  border-[#e4e0e0] hover:bg-[#F9FAFB] text-[14px]'>
                <td className='p-3 text-left '><input type="checkbox" /></td>
                <td className='p-3 text-left text-[#374151]'>Neil Sims</td>
                <td className='p-3 text-left'> <img src="https://packshifts.in/images/iso.png" className='w-12' alt="" /></td>
                <td className='p-3 text-left'>CEO Of SunPark	</td>
